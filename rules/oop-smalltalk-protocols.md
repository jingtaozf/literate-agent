...
> *Origin*: claude-agent; the principle generalises beyond that repo.
...
worth knowing, both from edo-literate's experience:
...
`Collaborator` layers (skill-scout-server's shape):
